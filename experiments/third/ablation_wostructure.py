...
# todo
from model.third.ablation.wostructure import MultiGNN_CFG_Model
...
def run(vul, seed):
    ...
    # todo
    save_dir = f"results/third/{vul}/ablation/wostructure/seed_{seed}"
...
if __name__ == "__main__":
    for vul in ["delegatecall", "integeroverflow", "timestamp", "reentrancy"]:
        ...
        # 保存
        # todo
        save_dir = f"results/third/{vul}/ablation/wostructure"
