...
# ====== 数据加载函数 ====== todo
from model.replace_conv1d_maxpooling import MultiModeModel
...
def run_all_vulnerabilities(config_model,
    ...
    for vul in vul_list:
        ...
        # todo 写入文件
        with open(f"../model_save/{model_save_dir}/conv1d/result_conv1d_max.txt", "a", encoding="utf-8") as f:
            f.write(result_str)
...
if __name__ == "__main__":
    ...
    # 写日志文件（追加模式）todo
    log_path = f"../model_save/{config_run['model_save_dir']}/conv1d/result_conv1d_max.txt"
